...
namespace Settings
{
	void LoadSettings(string szIniFile)
	{
		...
		{
			// ïèñòîëåòû what does this shit mean hhhhh
			if (i <= 9)
			{
		...
		Esp::esp_HitMarker = CSX::Cvar::LoadCvar(VISUAL_TEXT, CVAR_ESP_HITMARKER, Esp::esp_HitMarker) != false;

		Esp::esp_ChromeWorld = CSX::Cvar::LoadCvar(VISUAL_TEXT, CVAR_ESP_CHROMEWORLD, Esp::esp_ChromeWorld);
		Esp::esp_MinecraftMode = CSX::Cvar::LoadCvar(VISUAL_TEXT, CVAR_ESP_MINECRAFTMODE, Esp::esp_MinecraftMode);
		Esp::esp_LSDMode = CSX::Cvar::LoadCvar(VISUAL_TEXT, CVAR_ESP_LSDMODE, Esp::esp_LSDMode);
		...
		Misc::misc_Radar = CSX::Cvar::LoadCvar(MISC_TEXT, CVAR_MISC_RADAR, Misc::misc_Radar);
	...
	void SaveSettings(string szIniFile)
	{
		...
		CSX::Cvar::SaveCvar(VISUAL_TEXT, CVAR_ESP_CHROMEWORLD, Settings::Esp::esp_ChromeWorld);
		CSX::Cvar::SaveCvar(VISUAL_TEXT, CVAR_ESP_MINECRAFTMODE, Settings::Esp::esp_MinecraftMode);
		CSX::Cvar::SaveCvar(VISUAL_TEXT, CVAR_ESP_LSDMODE, Settings::Esp::esp_LSDMode);
		...
		CSX::Cvar::SaveCvar(MISC_TEXT, CVAR_MISC_RADAR, Misc::misc_Radar);
	...
	namespace Misc
	{
		...
		char* First_static = "SNAPSHOOK.XYZ";
		char* Second_static = "by Snaps-da-k1ng";
		char First[64];
		char Second[64];

		bool misc_InvChanger = true;
		bool misc_MedalChanger = true;
		bool misc_RankSpoof = true;
		bool misc_FilterList = true;
