...
namespace Engine
{
	...
	void ClanTag()
	{
		...
		case 2:
		{
			SetMyClanTag("snapshook", "snapshook.xyz");
			break;
		}
		case 3:
		{
			SetMyClanTag("snapshook.xyz \r", "snapshook.xyz");
			break;
		}
		case 4:
		{
		...
		case 6:
		{
			...
			case 12:
			{
				SetMyClanTag("sna         ", "snapshook.xyz");
				break;
			}
			case 13:
			{
			...
			case 16:
			{
				SetMyClanTag("snap/         ", "snapshook.xyz");
				break;
			}
			case 17:
			{
			...
			case 19:
			{
				SetMyClanTag("snaps         ", "snapshook.xyz");
				break;
			}
			case 20:
			{
			...
			case 23:
			{
				SetMyClanTag("snapsh         ", "snapshook.xyz");
				break;
			}
			case 24:
			{
			...
			case 27:
			{
				SetMyClanTag("snapsho         ", "snapshook.xyz");
				break;
			}
			case 28:
			{
			...
			case 31:
			{
				SetMyClanTag("snapshoo/         ", "snapshook.xyz");
				break;
			}
			case 32:
			{
	...
	{
		std::vector<std::string> chatspam = { "snapshook.xyz - The Best Legit Cheat Provider" };
	...
	void ChatSpamRandom()
	{
		std::vector<std::string> chatspamsss = { "SNAPSHOOK Tappin Niggers Everyday." , "I'm just evolving at this game" , "You just got fucked by Snapshook" , "Best Cheat in The World" };
